...
- **Step 3 — NEXT: products.jl, qa.jl, characterize.jl** + the `tools/` quick-looks (ladder
  rungs 1–2), starting from `dev/upstream_response_truth_bundle.md` (the truth-bundle reply on disk).
- **Then** steps 4–8 in `dev/PLAN.md`.
